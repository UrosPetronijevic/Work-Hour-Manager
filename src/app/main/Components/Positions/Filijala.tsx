        ...
        <ul className="flex flex-col gap-2 py-4 ml-10">
          <li className="flex">
            ...
            <span className="text-sky-300">
              {sakljucariGornjeData?.[0].sakljucar}
            </span>
          </li>
          <li>
            Prvi zamenik :
            <span className="text-sky-300">
              {sakljucariGornjeData?.[0].zamenik1}
            </span>
          </li>
          <li>
            Drugi zamenik:{" "}
            <span className="text-sky-300">
              {sakljucariGornjeData?.[0].zamenik2}
            </span>
          </li>
          <li>
            Prvi nepredvidjeni :{" "}
            <span className="text-sky-300">
              {sakljucariGornjeData?.[0].nepredvidjeni1}
            </span>
          </li>
          <li>
            Drugi nepredvidjeni :{" "}
            <span className="text-sky-300">
              {sakljucariGornjeData?.[0].nepredvidjeni2}
            </span>
          </li>
        </ul>
      </div>
