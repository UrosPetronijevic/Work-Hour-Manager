...
export default function SignupForm({}: SignupFormProps) {
  ...
  return (
    <div className="w-[35%] min-h-[85%] py-8 px-10 bg-white rounded-md shadow-md flex flex-col justify-between">
      ...
      <button className="py-2 px-6 text-white text-[1.2rem] bg-[#F99417] w-fit self-center rounded-[.5rem]">
        Registruj se
      </button>
    </div>
  );
